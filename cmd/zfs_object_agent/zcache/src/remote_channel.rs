...
impl RemoteChannel {
    ...
    pub async fn call(
        ...
        loop {
            ...
            nvlist.insert("request_type", request).unwrap();
            ...
            let response_type = response.lookup_string("response_type")?;

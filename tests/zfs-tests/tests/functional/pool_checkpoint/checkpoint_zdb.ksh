...
log_must eval "run_zdb -e \"-e\" -p $TESTPOOL | grep \"Checkpointed uberblock found\""
log_mustnot eval "run_zdb -e \"-k -e\" -p $TESTPOOL | grep \"Checkpointed uberblock found\""
log_mustnot eval "run_zdb -e \"-e\" -p $TESTPOOL | grep \"Dataset $FS1\""
log_must eval "run_zdb -e \"-k -e\" -p $TESTPOOL | grep \"Dataset $CHECKPOINTED_FS1\""

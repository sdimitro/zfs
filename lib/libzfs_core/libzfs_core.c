    ...
    boolean_t force, boolean_t raw, int fd)
{
	return (recv_impl(snapname, props, NULL, NULL, 0, origin, force,
	    B_FALSE, raw, B_FALSE, fd, NULL, NULL, NULL, NULL));
}
    ...
    int fd, const dmu_replay_record_t *begin_record)
{
	...
	return (recv_impl(snapname, props, NULL, NULL, 0, origin, force,
	    resumable, raw, B_FALSE, fd, begin_record, NULL, NULL, NULL));
}
...
{
	return (recv_impl(snapname, props, NULL, NULL, 0, origin, force,
	    resumable, raw, B_FALSE, input_fd, begin_record,
    ...
    nvlist_t **errors)
{
	return (recv_impl(snapname, props, cmdprops, wkeydata, wkeylen, origin,
	    force, resumable, raw, B_FALSE, input_fd, begin_record,
	    read_bytes, errflags, errors));
}
